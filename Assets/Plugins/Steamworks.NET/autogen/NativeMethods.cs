...
#region SteamController
		...
		[DllImport(NativeLibraryName, EntryPoint = "SteamAPI_ISteamController_ShowDigitalActionOrigins", CallingConvention = CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.I1)]
		...
		[DllImport(NativeLibraryName, EntryPoint = "SteamAPI_ISteamController_ShowAnalogActionOrigins", CallingConvention = CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.I1)]
